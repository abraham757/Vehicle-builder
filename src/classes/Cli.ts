...
class Cli {
  ...
  vehicles: (Car| Truck| Motorbike)[];//    tow(vehicle: Truck | Motorbike | Car): void;
  ...
  createTruck(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        );//const truck1 = new Truck(Cli.generateVin(),"red", "Ford", "F-150", 2021, 5000, 120, [], 10000,'Automatic');
        // push the car to the vehicles array
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        const motorbike = new Motorbike(
          ...
          parseInt(answers.year),
          parseInt(answers.weight),
          parseInt(answers.topSpeed), motorbike1Wheels
